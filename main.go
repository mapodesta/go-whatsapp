...
func main() {
	...
	//for {
		...
		/*fmt.Println("Press 1. Enviar mensaje de Texto")
		fmt.Println("Press 2. Enviar Imagen")
		fmt.Println("Press 3. Enviar mensaje Masivo desde archivo csv")
		fmt.Println("Press 4. Enviar Imagen Masiva desde archivo csv")
		fmt.Println("Press 5. Salir")*/

		//var s int
		//fmt.Scanln(&s)
		if s == 1 {
			//var v SendText
			//fmt.Print("Ingrese el numero Destinatario: ")
			//fmt.Scanln(&v.Receiver)
			//fmt.Print("Ingrese el mensaje: ")
			//input := bufio.NewReader(os.Stdin)
			//v.Message, _ = input.ReadString('\n')
			//var v SendText
			//wordPtr := flag.String("word", "ahora va", "a string") //mensaje
			//v.Message = *wordPtr
			//numbPtr := flag.String("numb", "3364521916", "an int") //numero
			//v.Receiver = *numbPtr
...
//Recibe una variable 'v' del tipo estructura SendText definida en la linea 18
